 ...
 */
const noAsyncEventMethods = {
    meta: {
        type: 'problem',
        docs: {
            description: 'Disallow using event methods (preventDefault, stopPropagation, stopImmediatePropagation) after an await expression or in promise chains',
            recommended: true,
            url: 'https://github.com/eslint-community/eslint-plugin-async-event',
        },
        messages: {
            noAsyncEventMethods: "Don't use event methods like preventDefault(), stopPropagation(), or stopImmediatePropagation() after an await or in promise chains. Call these methods before async operations.",
        },
        schema: [],
    },
    create(context) {
                ...
                if (node.callee.type === 'MemberExpression') {
                    ...
                    if (property.type === 'Identifier' &&
                        ...
                        if (isEventObject && objectName) {
                            ...
                            tracker.isInAsyncContext(objectName, 'noAsyncEventMethods', node, context);
                        }
                    }
                }
            },
...
exports.default = noAsyncEventMethods;
